@extends('adminmaster.adminmaster')
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="ed_mostrecomeded_course">
                            <div class="ed_item_img">
                                <img src="https://dummyimage.com/360x360/000/fff" alt="item1" class="img-responsive">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="ed_mostrecomeded_course">
                            ...
                            <div class="ed_item_description ed_most_recomended_data">
                                <h4><a href="course_single.html">management prog. </a><span>£43</span></h4>
                                <div class="row">
                                    <div class="ed_rating">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                            <div class="row">
                                ...
                                <div class="course_detail">
                                    <div class="course_faculty">
                                        <img src="https://dummyimage.com/263x263/000/fff" alt=""> <a href="instructor_dashboard.html">Tina Fibonacci</a>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="ed_mostrecomeded_course">
                            ...
                            <div class="ed_item_description ed_most_recomended_data">
                                <h4><a href="course_single.html">Model Specificity </a><span>£23</span></h4>
                                <div class="row">
                                    <div class="ed_rating">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                            <div class="row">
                                ...
                                <div class="course_detail">
                                    <div class="course_faculty">
                                        <img src="https://dummyimage.com/263x263/000/fff" alt=""> <a href="instructor_dashboard.html">Shy Tommy</a>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="ed_mostrecomeded_course">
                            ...
                            <div class="ed_item_description ed_most_recomended_data">
                                <h4><a href="course_single.html">mobile capabilities </a><span>£45</span></h4>
                                <div class="row">
                                    <div class="ed_rating">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                            <div class="row">
                                ...
                                <div class="course_detail">
                                    <div class="course_faculty">
                                        <img src="https://dummyimage.com/263x263/000/fff" alt=""> <a href="instructor_dashboard.html">Scott Again</a>
                                    </div>
                                </div>
