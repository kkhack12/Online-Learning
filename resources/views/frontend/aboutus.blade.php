                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-8 col-sm-6">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="about ">About Educo</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="ed_graysection ed_toppadder90 ed_bottompadder90">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="ed_counter_wrapper row">
                    ...
                    <div class="ed_team_wrapper row">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="ed_team_member">
                                ...
                                <div class="ed_team_member_description">
                                    <h4><a href="instructor_dashboard ">Andre House</a></h4>
                                    <h5>director</h5>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="ed_team_member">
                                ...
                                <div class="ed_team_member_description">
                                    <h4><a href="instructor_dashboard ">Frank Pascole</a></h4>
                                    <h5>principle</h5>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="ed_team_member">
                                ...
                                <div class="ed_team_member_description">
                                    <h4><a href="instructor_dashboard ">Tina Bonucci</a></h4>
                                    <h5>t.p.o.</h5>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="ed_team_member">
                                ...
                                <div class="ed_team_member_description">
                                    <h4><a href="instructor_dashboard ">Shy Tommus</a></h4>
                                    <h5>h.o.d.</h5>
